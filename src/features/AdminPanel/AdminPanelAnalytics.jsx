...
//       title: "Transition",
//       value: `${(
//         (viewStats.value.actions / viewStats.value.views) *
//         100
//       ).toFixed(0)} %`,
//       diff: 18,
//     },
...
//     },
//     {
//       label: ["SuperAdmin", "SubAdmin"].includes(userRole)
//         ? "Agencies"
//         : "Credits",
//       stats: ["SuperAdmin", "SubAdmin"].includes(userRole)
...
export default function AdminPanelAnalytics() {
  ...
  //  console.log(credits.value)
   const data = signal([
    ...
    {
      title: "Transition",
      value: `${((viewStats.value.actions / viewStats.value.views) * 100).toFixed(
        0
      )} %`,
      diff: 18,
    },
